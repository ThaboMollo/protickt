...
-- FIRST: Authentication → Users → Add user (email + password, auto-confirm),
-- then this grants that user access to the admin app.
-- ---------------------------------------------------------------------------
insert into admin_users (user_id)
select id from auth.users where email = 'mollo.t.mponya@gmail.com'
